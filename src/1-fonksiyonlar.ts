...
// Kodu buraya yazalım...
function kardesPayi(isim?:string) {
    if (isim) {
     console.log(`Bir tane ${isim} için, bir de benim için.`);
   } else {
...
function isLeapYear(year: number): boolean {
   ...
   const yearConstrol4 = year % 4 === 0;
   const yearConstrol100 = year % 100 !== 0;
   const yearConstrol400 = year % 400 === 0;

   console.log((yearConstrol4 && yearConstrol100) || yearConstrol400);
}
